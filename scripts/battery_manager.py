...
######## Implement a service to recharge battery, to call anly when room E has been reached ##########
...
class BatteryManager:
    ...
    def __init__(self):
        ...
        # Log information.
        log_msg = (f'Initialise node `{anm.NODE_ROBOT_STATE}` that publishes on topic {anm.TOPIC_BATTERY_LOW}.')
        rospy.loginfo(anm.tag_log(log_msg, LOG_TAG))
